...
const activeScenarioOptions = computed(() => attachmentScenarios);
...
const activeComponent = computed(() => DownloadAttachmentApp);
...
function resolveInitialScenarioID(view) {
  ...
  const options = attachmentScenarios;
